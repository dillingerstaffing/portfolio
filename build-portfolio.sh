...
git add data/cards.json data/articles.json data/chips.json data/isa-decisions.json data/wigmore.json data/feed.json index.src.html index.html build.py build-portfolio.sh BUILD.md drift-gate.py sitemap.xml og-image.png blog feed
git commit -m "$1"
git push
